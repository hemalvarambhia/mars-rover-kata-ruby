...
class TurningMarsRoverRightTest < Minitest::Test
  ...
  def test_turning_south_facing_mars_rover
    mars_rover = MarsRover.new(starting_coordinates: Coordinates.new(x: 2, y: -3), direction: 'S')
  ...
  def test_turning_west_facing_mars_rover
    mars_rover = MarsRover.new(starting_coordinates: Coordinates.new(x: 0, y: 0), direction: 'W')
  ...
  def test_turning_north_facing_rover_twice
    mars_rover = MarsRover.new(starting_coordinates: Coordinates.new(x: 3, y: 3), direction: 'N')
