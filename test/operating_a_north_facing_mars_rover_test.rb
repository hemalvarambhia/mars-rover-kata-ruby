...
class OperatingANorthFacingMarsRoverTest < Minitest::Test
  ...
  def test_moving_backwards_from_the_southern_edge
    skip('Test list')
    mars_rover = mars_rover_oriented_northward(Coordinates.new(x: 1, y: -6))
  ...
  def mars_rover_oriented_northward(starting_position)
    VehicleController.new(starting_position: nil, orientation: nil, vehicle: MarsRover.new(starting_position: starting_position, orientation: 'N'))
  end
end
