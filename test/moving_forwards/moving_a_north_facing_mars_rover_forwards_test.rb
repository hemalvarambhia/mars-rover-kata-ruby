...
class MovingANorthFacingMarsRoverForwardsTest < Minitest::Test
  include CoordinatesAssertion

  def test_moving_one_step_forward_from_the_origin
    planet = TorusShapedPlanet.new(northern_edge: nil, eastern_edge: nil, southern_edge: -5, western_edge: nil)
  ...
  def test_moving_forwards_from_the_northern_edge
    planet = TorusShapedPlanet.new(northern_edge: 5, eastern_edge: nil, southern_edge: -5, western_edge: nil)
    mars_rover = mars_rover(planet, Coordinates.new(x: 1, y: 5))
  ...
  def test_mars_rover_cannot_move_forward_when_obstacle_is_in_front
    planet = TorusShapedPlanet.new(northern_edge: 6, eastern_edge: nil, southern_edge: -6, western_edge: nil, obstacles: [Coordinates.new(x: 0, y: 1)])
    mars_rover = mars_rover(planet, Coordinates.new(x: 0, y: 0))
  ...
  def test_mars_rover_can_move_forward_up_to_an_obstacle_and_not_beyond
    planet = TorusShapedPlanet.new(northern_edge: 5, eastern_edge: nil, southern_edge: -5, western_edge: nil, obstacles: [Coordinates.new(x: 0, y: 3)])
    mars_rover = mars_rover(planet, Coordinates.new(x: 0, y: 0))
  ...
  def test_mars_rover_can_move_forward_when_obstacle_is_adjacent
    planet = TorusShapedPlanet.new(northern_edge: 5, eastern_edge: 5, southern_edge: -5, western_edge: -5, obstacles: [Coordinates.new(x: 0, y: 2)])
  ...
  def test_mars_rover_cannot_move_past_northern_edge_when_obstacle_is_located_on_southern_edge
    planet = TorusShapedPlanet.new(northern_edge: 6, eastern_edge: nil, southern_edge: -6, western_edge: nil, obstacles: [Coordinates.new(x: 0, y: -6)])
    mars_rover = mars_rover(planet, Coordinates.new(x: 0, y: 6))
