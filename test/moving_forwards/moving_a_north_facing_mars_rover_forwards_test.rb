...
class MovingANorthFacingMarsRoverForwardsTest < Minitest::Test
  ...
  def test_moving_one_step_forward_from_the_origin
    planet = TorusBasedPlanet.new(northern_edge: nil, eastern_edge: nil, southern_edge: -5, western_edge: nil)
  ...
  def test_mars_rover_cannot_move_forward_when_obstacle_is_in_front
    planet = TorusBasedPlanet.new(northern_edge: 6, eastern_edge: nil, southern_edge: -6, western_edge: nil, obstacles: [Coordinates.new(x: 0, y: 1)])
    mars_rover = mars_rover_oriented_northward(planet, Coordinates.new(x: 0, y: 0))
  ...
  def test_mars_rover_can_move_forward_up_to_an_obstacle_and_not_beyond
    planet = TorusBasedPlanet.new(northern_edge: 5, eastern_edge: nil, southern_edge: -5, western_edge: nil, obstacles: [Coordinates.new(x: 0, y: 3)])
    mars_rover = mars_rover_oriented_northward(planet, Coordinates.new(x: 0, y: 0))
  ...
  def test_mars_rover_can_move_forward_when_obstacle_is_adjacent
    planet = TorusBasedPlanet.new(northern_edge: 5, eastern_edge: 5, southern_edge: -5, western_edge: -5, obstacles: [Coordinates.new(x: 0, y: 2)])
  ...
  def test_mars_rover_cannot_move_past_northern_edge_when_obstacle_is_located_on_southern_edge
    planet = TorusBasedPlanet.new(northern_edge: 6, eastern_edge: nil, southern_edge: -6, western_edge: nil, obstacles: [Coordinates.new(x: 0, y: -6)])
