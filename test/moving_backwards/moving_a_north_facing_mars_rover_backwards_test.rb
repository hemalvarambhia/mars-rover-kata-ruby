...
class MovingANorthFacingMarsRoverBackwardsTest < Minitest::Test
  ...
  def test_no_command_moves_mars_rover_nowhere
    mars_rover = mars_rover(nil, Coordinates.new(x: 0, y: 0))
  ...
  def test_moving_one_step_backwards_from_any_position
    ...
    mars_rover = mars_rover(planet, Coordinates.new(x: 2, y: 1))
  ...
  def test_moving_backwards_leaves_orientation_unchanged
    planet = TorusShapedPlanet.new(northern_edge: 5, eastern_edge: nil, southern_edge: -5, western_edge: nil)
    mars_rover = mars_rover(planet, Coordinates.new(x: 0, y: 1))
  ...
  def test_an_unsupported_command_does_nothing_to_the_mars_rover
    planet = TorusShapedPlanet.new(northern_edge: 5, eastern_edge: nil, southern_edge: -5, western_edge: nil)
    mars_rover = mars_rover(planet, Coordinates.new(x: 4, y: 1))
  ...
  def test_moving_backwards_to_the_southern_edge
    mars_rover =
      mars_rover(
        TorusShapedPlanet.new(northern_edge: 6, eastern_edge: nil, southern_edge: -6, western_edge: nil),
  ...
  def test_mars_rover_can_move_backwards_up_to_an_obstacle_and_not_beyond
    planet = TorusShapedPlanet.new(northern_edge: 7, eastern_edge: 7, southern_edge: -6, western_edge: -6, obstacles: [Coordinates.new(x: 1, y: -5)])
  ...
  def test_mars_rover_can_move_backwards_when_obstacle_is_adjacent
    planet = TorusShapedPlanet.new(northern_edge: 5, eastern_edge: 5, southern_edge: -5, western_edge: -5, obstacles: [Coordinates.new(x: 1, y: 0)])
    mars_rover = mars_rover(planet, Coordinates.new(x: 0, y: 0))
  ...
  def test_mars_rover_cannot_move_past_southern_edge_when_obstacle_is_located_on_northern_edge
    planet = TorusShapedPlanet.new(northern_edge: 5, eastern_edge: nil, southern_edge: -5, western_edge: nil, obstacles: [Coordinates.new(x: 1, y: 5)])
