...
class MovingANorthFacingMarsRoverBackwardsTest < Minitest::Test
  ...
  def test_moving_backwards_to_the_southern_edge
    mars_rover =
      mars_rover_oriented_northward(
        TorusBasedPlanet.new(northern_edge: 6, eastern_edge: nil, southern_edge: -6, western_edge: nil),
  ...
  def test_mars_rover_cannot_move_backwards_when_obstacle_is_behind_it
    planet = TorusBasedPlanet.new(northern_edge: 5, eastern_edge: 5, southern_edge: -5, western_edge: -5, obstacles: [Coordinates.new(x: 0, y: -1)])
  ...
  def test_mars_rover_can_move_backwards_up_to_an_obstacle_and_not_beyond
    planet = TorusBasedPlanet.new(northern_edge: 7, eastern_edge: 7, southern_edge: -6, western_edge: -6, obstacles: [Coordinates.new(x: 1, y: -5)])
  ...
  def test_mars_rover_cannot_move_past_southern_edge_when_obstacle_is_located_on_northern_edge
    planet = TorusBasedPlanet.new(northern_edge: 5, eastern_edge: nil, southern_edge: -5, western_edge: nil, obstacles: [Coordinates.new(x: 1, y: 5)])
