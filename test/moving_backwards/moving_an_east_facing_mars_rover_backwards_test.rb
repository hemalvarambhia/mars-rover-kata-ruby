...
class MovingAnEastFacingMarsRoverBackwardsTest < Minitest::Test
  ...
  def test_moving_one_step_backwards_from_any_position
    ...
    mars_rover = mars_rover(planet, Coordinates.new(x: 3, y: 5))
  ...
  def test_an_unsupported_command_does_nothing_to_the_mars_rover
    planet = TorusShapedPlanet.new(northern_edge: nil, eastern_edge: 5, southern_edge: nil, western_edge: -5)
    mars_rover = mars_rover(planet, Coordinates.new(x: 3, y: 2))
  ...
  def test_moving_backwards_to_the_western_edge
    planet = TorusShapedPlanet.new(northern_edge: 5, eastern_edge: 5, southern_edge: -6, western_edge: -6)
    mars_rover = mars_rover(planet, Coordinates.new(x: -5, y: -2))
  ...
  def test_moving_backwards_from_the_western_edge
    planet = TorusShapedPlanet.new(northern_edge: 5, eastern_edge: 5, southern_edge: -6, western_edge: -6)
    mars_rover = mars_rover(planet, Coordinates.new(x: -6, y: 4))
  ...
  def test_mars_rover_cannot_move_backwards_when_obstacle_is_behind_it
    planet = TorusShapedPlanet.new(northern_edge: nil, eastern_edge: 4, southern_edge: nil, western_edge: -4, obstacles: [Coordinates.new(x: -2, y: 0)])
    mars_rover = mars_rover(planet, Coordinates.new(x: -1, y: 0))
  ...
  def test_mars_rover_cannot_move_past_western_edge_when_obstacle_is_located_on_eastern_edge
    planet = TorusShapedPlanet.new(northern_edge: nil, eastern_edge: 5, southern_edge: nil, western_edge: -5, obstacles: [Coordinates.new(x: 5, y: -1)])
    mars_rover = mars_rover(planet, Coordinates.new(x: -5, y: -1))
